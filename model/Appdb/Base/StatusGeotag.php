...
/**
 * Base class that represents a row from the 'ref.status_geotag' table.
 *
 *
 *
 * @package    propel.generator.Appdb.Base
 */
abstract class StatusGeotag implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Appdb\\Map\\StatusGeotagTableMap';
    ...
    /**
     * The value for the nama_status_geotag field.
     *
     * @var        string
     */
    protected $nama_status_geotag;
    ...
    /**
     * Initializes internal state of Appdb\Base\StatusGeotag object.
     */
    ...
    /**
     * Compares this with another <code>StatusGeotag</code> instance.  If
     * <code>obj</code> is an instance of <code>StatusGeotag</code>, delegates to
     * <code>equals(StatusGeotag)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|StatusGeotag The current object, for fluid interface
     */
    ...
    /**
     * Get the [nama_status_geotag] column value.
     *
     * @return string
     */
     ...
     * @return $this|\Appdb\StatusGeotag The current object (for fluent API support)
     */
    public function setStatusGeotagId($v)
    {
        ...
        if ($this->status_geotag_id !== $v) {
            ...
            $this->modifiedColumns[StatusGeotagTableMap::COL_STATUS_GEOTAG_ID] = true;
        }
    ...
    /**
     * Set the value of [nama_status_geotag] column.
     *
     * @param string $v new value
     * @return $this|\Appdb\StatusGeotag The current object (for fluent API support)
     */
    public function setNamaStatusGeotag($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nama_status_geotag !== $v) {
            $this->nama_status_geotag = $v;
            $this->modifiedColumns[StatusGeotagTableMap::COL_NAMA_STATUS_GEOTAG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StatusGeotagTableMap::translateFieldName('StatusGeotagId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status_geotag_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StatusGeotagTableMap::translateFieldName('NamaStatusGeotag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nama_status_geotag = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = StatusGeotagTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Appdb\\StatusGeotag'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStatusGeotagQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StatusGeotag::setDeleted()
     * @see StatusGeotag::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStatusGeotagQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatusGeotagTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    {
        $pos = StatusGeotagTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getNamaStatusGeotag();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['StatusGeotag'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StatusGeotag'][$this->hashCode()] = true;
        $keys = StatusGeotagTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStatusGeotagId(),
            $keys[1] => $this->getNamaStatusGeotag(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Appdb\StatusGeotag
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setNamaStatusGeotag($value);
                break;
        } // switch()
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setStatusGeotagId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setNamaStatusGeotag($arr[$keys[1]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Appdb\StatusGeotag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusGeotagTableMap::COL_STATUS_GEOTAG_ID)) {
            $criteria->add(StatusGeotagTableMap::COL_STATUS_GEOTAG_ID, $this->status_geotag_id);
        }
        if ($this->isColumnModified(StatusGeotagTableMap::COL_NAMA_STATUS_GEOTAG)) {
            $criteria->add(StatusGeotagTableMap::COL_NAMA_STATUS_GEOTAG, $this->nama_status_geotag);
        }
    ...
    {
        $criteria = ChildStatusGeotagQuery::create();
        $criteria->add(StatusGeotagTableMap::COL_STATUS_GEOTAG_ID, $this->status_geotag_id);
    ...
    {
        $validPk = null !== $this->getStatusGeotagId();
    ...
    /**
     * Generic method to set the primary key (status_geotag_id column).
     *
    ...
    {
        return null === $this->getStatusGeotagId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Appdb\StatusGeotag (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNamaStatusGeotag($this->getNamaStatusGeotag());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Appdb\StatusGeotag Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildStatusGeotag is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildStatusGeotag The current object (for fluent API support)
     */
    public function setGeotags(Collection $geotags, ConnectionInterface $con = null)
    {
        ...
        foreach ($geotagsToDelete as $geotagRemoved) {
            $geotagRemoved->setStatusGeotag(null);
        }
     ...
     * Otherwise if this StatusGeotag is new, it will return
     * an empty collection; or if this StatusGeotag has previously
     * been saved, it will retrieve related Geotags from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StatusGeotag.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(StatusGeotagTableMap::DEFAULT_STRING_FORMAT);
    }
